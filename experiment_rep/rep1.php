...
<form id="input-group" method="POST">
    <div class="input-group">
        ...
        <button type="button" class="btn btn-secondary" onclick="window.location.href='rep1.php'">إعادة تحميل</button>
...
<table>
    ...
    <?php
        ...
        if (!empty($startDate) && !empty($endDate)) {
            // إذا تم إدخال كل من تاريخ البداية وتاريخ النهاية
            $sql .= " WHERE date BETWEEN '$startDate' AND '$endDate'";
        } elseif (!empty($startDate)) {
            // إذا تم إدخال تاريخ البداية فقط
