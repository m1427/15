...
<html lang="ar" dir="rtl">        
        ...
        <form id="input-group" method="POST">
            <div class="input-group">
                ...
                <button type="button" class="btn btn-secondary" onclick="window.location.href='rep1.p.php'">إعادة تحميل</button>
...
WHERE sub IN (
    'فيزياء 1','فيزياء 1-1','فيزياء 1-2','فيزياء 1-3',
    'فيزياء 2','فيزياء 2-1','فيزياء 2-2','فيزياء 2-3',
    'فيزياء 3','فيزياء 3-1','فيزياء 3-2','فيزياء 3-3'
)";
