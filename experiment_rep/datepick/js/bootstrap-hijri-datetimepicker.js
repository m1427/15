...
(function (factory) {
    ...
    var hijriDatePicker = function (element, options) {
        ...
        var picker = {},
                ...
                if (d === undefined || d === null) {
                    ...
                    if (tzEnabled) {
                        ...
                        if (incomingZoneOffset !== currentZoneOffset) {
                            ...
                            dateWithTimeZoneInfo = moment(d, parseFormats, options.useStrict).format('DD-MM-YYYY[T]HH:mm:ss') + timeZoneIndicator;
            ...
            fillMonths = function () {
                ...
                var spans = [],
                    monthsShort = viewDate.clone().startOf('day').startOf('y');
            ...
            indexGivenDates = function (givenDatesArray) {
                ...
                $.each(givenDatesArray, function () {
                    ...
                    if (dDate.isValid()) {
                        givenDatesIndexed[dDate.format('YYYY-MM-YYYY')] = true;
                    }
                });
        ...
        picker.hijri = function (hijri) {
            if (arguments.length === 0) {
                if (options.hijri) {
                    options.viewModes = ['years', 'months', 'days'];
                }
            ...
            if (options.hijri) {
                options.viewModes = /*['days', 'months', 'years'];*/['years', 'months', 'days'];
            }
            return picker;
        };
        ...
        picker.locale = function (locale) {
            ...
            if (actualFormat) {
                format = 'YYYY-MM-DD'; // reinit formatting
            }
    ...
    $.fn.hijriDatePicker.defaults = {
        ...
        hijriDayViewHeaderFormat: 'iYYYY iMMMM',
