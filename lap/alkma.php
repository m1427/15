...
<head>
    ...
    <style>
        ...
        /* تغيير النمط على الشاشات متوسطة الحجم */
...
<body>
    <form method="post" id="booking-form" > 
        ...
        <main>
            ...
            <label style="margin-right: 10px;" for="sub">المقرر</label>
            ...
            <label style="margin-right: 10px;" for="your_class">الشعبة</label>
...
<datalist id="experimentToolOptions">
 <?php
  ...
  <button type="button" name="submit" id="submit-button">إرسال</button>
  ...
  <div id="confirmation-modal">
    <div class="modal-content">
        ...
        <button type="sumbit" id="confirm-button">تأكيد</button>
    </div>
</div>
...
<script>
  document.getElementById("sub").addEventListener("change", function () {
    ...
    xhr.open("POST", "php/subject/get_classes_alkma.php", true);
