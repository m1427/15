...
<body>
    <form method="post" id="booking-form" > 
        <header>
            <h2> شكراً للدخولك لمعمل الفيزياء</h2>
        ...
        <main>
            ...
            <select id="teatchername" name="teatchername" required>
                ...
                $sql = "SELECT teatchername FROM teatcher_name where sub= 'فيزياء'"; // تعديل استعلام SQL حسب الجدول و الأعمدة لديك
            ...
            <?php
                ...
                // استعلام SQL لجلب البيانات
                $sql = "SELECT sub, num FROM books where sub= 'فيزياء'"; // تعديل استعلام SQL حسب الجدول و الأعمدة لديك
                $result = $conn->query($sql);
