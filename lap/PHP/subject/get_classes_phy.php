...
if ($selected_subject === "فيزياء 1" || $selected_subject === "فيزياء 1-1" || $selected_subject === "فيزياء 1-2" || $selected_subject === "فيزياء 1-3") {
    $range = range($row["lower1"], $row["high1"]);
} elseif ($selected_subject === "فيزياء 2" || $selected_subject === "فيزياء 2-1" || $selected_subject === "فيزياء 2-2" || $selected_subject === "فيزياء 2-3") {
    $range = range($row["lower2"], $row["high2"]);
} elseif ($selected_subject === "فيزياء 3" || $selected_subject === "فيزياء 3-1" || $selected_subject === "فيزياء 3-2" || $selected_subject === "فيزياء 3-3") {
