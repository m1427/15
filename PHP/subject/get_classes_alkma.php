...
if ($selected_subject === "كيمياء 1" || $selected_subject === "كيمياء 1-1" || $selected_subject === "كيمياء 1-2" || $selected_subject === "كيمياء 1-3") {
    $range = range($row["lower1"], $row["high1"]);
} elseif ($selected_subject === "كيمياء 2" || $selected_subject === "كيمياء 2-1" || $selected_subject === "كيمياء 2-2" || $selected_subject === "كيمياء 2-3") {
    $range = range($row["lower2"], $row["high2"]);
} elseif ($selected_subject === "كيمياء 3" || $selected_subject === "كيمياء 3-1" || $selected_subject === "كيمياء 3-2" || $selected_subject === "كيمياء 3-3") {
